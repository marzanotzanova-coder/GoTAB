const i18n = {
  kk: {
    ...
    quizLoading: "Жүктелуде…",
    quizNotFound: "Бұл сабаққа сынақ әлі қосылмаған.",
    quizProgress: "{answered}/{total} сұраққа жауап берілді",
    quizSubmit: "Сынақты аяқтау",
    quizConfirm: "Барлық сұраққа жауап берілмеді. Жіберуге сенімдісіз бе?",
    quizResultTitle: "Нәтижеңіз",
    quizScoreLine: "Нәтижеңіз: {correct}/{total}",
    quizCorrectLbl: "Дұрыс жауаптар",
    quizWrongLbl: "Қате жауаптар",
    quizPercentLbl: "Пайыз",
    quizRetry: "Жабу",
    quizAdminTitle: "📋 Сынақ қосу / өңдеу",
    quizAdminResults: "📊 Сынақ нәтижелері",
    quizSaveBtn: "Сынақты сақтау",
    quizPreviewBtn: "Алдын ала көру",
    quizSaveOk: "✅ Сынақ сақталды!",
    quizSaveFail: "Сынақ сақталмады.",
    quizSaving: "Сақталуда…",
  ...
  ru: {
    ...
    quizLoading: "Загрузка…",
    quizNotFound: "Тест для этого урока ещё не добавлен.",
    quizProgress: "{answered}/{total} ответов дано",
    quizSubmit: "Завершить тест",
    quizConfirm: "Не на все вопросы даны ответы. Отправить?",
    quizResultTitle: "Ваш результат",
    quizScoreLine: "Результат: {correct}/{total}",
    quizCorrectLbl: "Правильных ответов",
    quizWrongLbl: "Ошибок",
    quizPercentLbl: "Процент",
    quizRetry: "Закрыть",
    quizAdminTitle: "📋 Добавить / редактировать тест",
    quizAdminResults: "📊 Результаты тестов",
    quizSaveBtn: "Сохранить тест",
    quizPreviewBtn: "Предпросмотр",
    quizSaveOk: "✅ Тест сохранён!",
    quizSaveFail: "Тест не сохранён.",
    quizSaving: "Сохранение…",
    aiTitle: "ИИ Помощник",
