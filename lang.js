const i18n = {
  kk: {
    ...
    checkVideo: "Видео көрілді",
    checkUpload: "Тапсырма жүктелді",
    checkTest: "Сынақ тапсырылды",
    checkAI: "ЖИ қолданылды",
  ...
  ru: {
    ...
    breadPremium: "# Премиум курс",
    // dashboard dynamic strings
    checkVideo: "Видео просмотрено",
    checkUpload: "Задание загружено",
    checkTest: "Тест сдан",
    checkAI: "ИИ использован",
