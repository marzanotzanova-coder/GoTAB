const i18n = {
  kk: {
    ...
    aiBackBtn: "← Артқа",
    aiQuotaError: "Gemini сервисі қазір бос емес. 1–2 минуттан кейін қайталаңыз.",
    aiGeminiRateLimit: "Gemini сервисі қазір бос емес. 1–2 минуттан кейін қайталаңыз.",
  ...
  ru: {
    ...
    aiBackBtn: "← Назад",
    aiQuotaError: "Сервис Gemini временно недоступен. Повторите через 1–2 минуты.",
    aiGeminiRateLimit: "Сервис Gemini временно недоступен. Повторите через 1–2 минуты.",
